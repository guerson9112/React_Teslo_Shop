                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="grid gap-2">
                                <div className="flex items-center">
                                    <Label htmlFor="password">Contraseña<a href="http://" target="_blank" rel="noopener noreferrer"></a></Label>
                            ...
                            <div className="grid gap-2">
                                <div className="flex items-center">
                                    <Label htmlFor="password">Confirma tu contraseña<a href="http://" target="_blank" rel="noopener noreferrer"></a></Label>
